...
from classes import H5Dataset, ChamferLoss, QuaternionLoss, RotLoss, ChamferQuatLoss
...
MODEL_LOCATION = "trained_models/model.pt"
MAX_EPOCHS = 20000
LEARNING_RATE = 1e-3
LOG_INTERVAL = 1
RUNNING_MEAN = 100
...
loss_chamfer_quat = ChamferQuatLoss(8, device)
