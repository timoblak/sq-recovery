...
if __name__ == "__main__":
    data_csv = parse_csv("../data/annotations/data_rot.csv")
    data_val_csv = parse_csv("../data/annotations/data_rot_val.csv")
    ...
    train_generator = data_gen_quats(data_val_csv, path_to_val_data, BATCH_SIZE)
    val_generator = data_gen_quats(data_val_csv, path_to_val_data, BATCH_SIZE)
